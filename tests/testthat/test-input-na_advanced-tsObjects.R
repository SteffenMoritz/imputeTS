...
test_that("multivariate tibble objects",
          {
            ...
            if (!requireNamespace("tibble", quietly = TRUE)) {
              ...
              expect_that(anyNA(na_interpolation(z)), is_false())
              expect_that(anyNA(na_locf(z)), is_false())
              expect_that(anyNA(na_ma(z)), is_false())
              expect_that(anyNA(na_random(z)), is_false())
              expect_that(anyNA(na_seadec(z)), is_false())
              expect_that(anyNA(na_seasplit(z)), is_false())
              expect_that(anyNA(na_replace(z)), is_false())
            }
          })
